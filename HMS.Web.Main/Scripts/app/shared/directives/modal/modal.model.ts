...
module ModalDirective {
    ...
    export class ModalStyle {
        ...
        constructor(modalSize = '', modalLeftStyle = 'col-lg-4', modalRightStyle = 'col-lg-8', confirmButtonStyle = 'btn-success', cancelButtonStyle = 'btn-default') {
